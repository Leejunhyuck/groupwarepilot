...
import org.raccoon.project.chat.service.ChatService;
...
public class ChatController {
    ...
    public ChatController(JwtTokenProvider jwtTokenProvider, ChatRoomRepository chatRoomRepository, ChatService chatService){
